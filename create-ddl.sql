...
ALTER TABLE EMPLOYEE ADD salary NUMBER DEFAULT 1000  NOT NULL;
ALTER TABLE EMPLOYEE ADD date_started DATE DEFAULT sysdate NOT NULL;


UPDATE EMPLOYEE SET date_started = to_date('2015-02-1', 'yyyy-mm-dd') WHERE EMP_ID = 1;
